...
public class RegisterActivity  extends AppCompatActivity {
    ...
    private void init(){
        ...
        UniversalImageLoader.setImage("assets://logo.jpg", mLogo);
        UniversalImageLoader.setImage("assets://foo.png",footer);
        UniversalImageLoader.setImage("assets://line.png",line);
    }
    ...
    private void initImageLoader(){
        UniversalImageLoader imageLoader = new UniversalImageLoader(RegisterActivity.this);
